...
Offworld combines  Datastar's interstellar symbolism with Replicant's reference to the film /Blade Runner/:
  ...
  | 🎫   | nextjournal.offworld/claim   | A value which rides the dispatch end-to-end, via a server-continuation | Your personal items will be held in a secure vault for the duration of your voyage (subject to routine inspection). |
   | 🦄   | nextjournal.offworld/inline  | An anonymous continuation, held behind a token derived from its source | "It's too bad she won't live! But then again, who does?"                                                            |
...
offworld defunctionalizes the cursor.

writes name a place, not a meaning.

places should be downstream of intents.
